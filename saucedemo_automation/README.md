...
- Google Chrome **or** Firefox (both are well-tested on Fedora)
- Git

Install system packages if needed:
```bash
# Fedora – install Python, pip, git, and Chrome/Firefox
...
# Option B – Firefox (already installed on most Fedora systems)
...
> **Note:** `webdriver-manager` automatically downloads the correct ChromeDriver / GeckoDriver for your installed browser — no manual driver installation needed.
...
# or: firefox reports/report.html
```
